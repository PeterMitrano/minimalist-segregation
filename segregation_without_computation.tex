...
\begin{abstract}
  In this paper, we demonstrate that robots which directly map a single ternary sensor readings to wheel speeds, perform no explicit communication are capable of $n$-class segregation. We perform a grid search over all parameters to understand the full parameter space and then analyze the best controller. We prove that certain sub-behaviors of segregation are guaranteed.
\end{abstract}
