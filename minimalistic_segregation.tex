...
of why convergence is guaranteed for the best parameters we found;
and \emph{(iii)} An analysis of the robustness of the algorithm to noise, scale,
...
indicate that robust minimalistic segregation in reality is possible, although not
guaranteed.
