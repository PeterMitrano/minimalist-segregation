...
\begin{figure}[t]
  \centering
  \includegraphics[width=0.49\columnwidth]{./images/segregation_example_1_class_small}
  \includegraphics[width=0.49\columnwidth]{./images/segregation_example_2_class_small}
  \includegraphics[width=0.49\columnwidth]{./images/segregation_example_3_class_small}
  \includegraphics[width=0.49\columnwidth]{./images/segregation_example_4_class_small}
  \includegraphics[width=0.49\columnwidth]{./images/segregation_example_5_class_small}
  \includegraphics[width=0.49\columnwidth]{./images/segregation_example_6_class_small}
