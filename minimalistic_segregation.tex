...
\ang{15}, and angles smaller or larger became progressively worse. We found that
...
\begin{figure}[t]
  ...
  \caption{A \ang{15} degree half beam angle is best for segregation. Lower cost
    is better.}
...
parameters we are able to construct theoretical guarantees on the emergent
behavior in a simplified setting.  We performed a grid search to learn about the
...
indicate that, despite the simplicity of our approach, $N$-class segregation
emerges and is robust.
